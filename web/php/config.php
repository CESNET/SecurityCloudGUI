<?php
	...
	$IPFIXCOL_DATA		= '/data/';							// Path to folder where query and graph data will be stored
	$IPFIXCOL_CFG		= $IPFIXCOL_DATA.'profiles.xml';	// Path to the ipfixcol profile configuration file.
